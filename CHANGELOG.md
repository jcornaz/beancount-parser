...
* Added `as_*` helper methods to enums (Thanks @jakobhellermann)
...
[Unreleased]: https://github.com/jcornaz/beancount-parser/compare/v2.6.0...HEAD
[2.6.0]: https://github.com/jcornaz/beancount-parser/compare/v2.5.0...v2.6.0
